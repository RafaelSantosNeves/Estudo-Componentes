...
namespace Componentes
{
    public partial class F_ComboBox : Form
    {
        ...
        private void btn_resetarElementos_Click(object sender, EventArgs e)
        {
            ...
            tr.AddRange(new List<string> { "Carro", "Avião", "Navio", "Ônibus", "Trem" });
        ...
        private void btn_adicionarNovoTransport_Click(object sender, EventArgs e)
        {
            if(tb_transporte.Text.Length > 0)
            {
